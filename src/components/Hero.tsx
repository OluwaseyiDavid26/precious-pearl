        ...
        <div className="py-20 lg:py-32">
          <div className="max-w-[680px]">
            ...
            <div className="hero-animate flex flex-wrap items-center gap-4 mb-16">
              ...
              <Link
                href="/#contact" // Change this if your route is different (e.g. /contact)
                className="border border-white/50 hover:border-white hover:bg-white/10 text-white text-[11px] font-semibold tracking-[0.16em] uppercase px-10 py-[15px] transition-all duration-200"
                style={{ fontFamily: "var(--font-barlow), sans-serif" }}
              >
                Get Involved
              </Link>
