...
//   const { ref: pageRef, visible: animate } = useScrollReveal(0.05);
...
//       },
//       body: JSON.stringify({
//         access_key: "72206548-8ec7-4a0b-9b98-583b75d7db96",
//         name: formState.name,
//         email: formState.email,
//         subject: `New Contact: ${formState.reason}`,
...
//             {/* Body */}
//             <p
//               className="text-white/55 text-[15px] leading-[1.9] mb-10 max-w-md"
//               style={slide(animate, 0.2)}
//             >
...
//             {/* Office hours badge */}
//             <div
//               className="inline-flex items-center gap-2 bg-[#F5C400]/10 border border-[#F5C400]/20 rounded-full px-4 py-2 mb-10"
//               style={slide(animate, 0.28)}
//             >
...
//                   style={slide(animate, 0.34 + i * 0.1)}
//                 >
...
//           {/* ── Right: form — curtain unfold from top ── */}
//           <div
//             className="bg-white/[0.04] border border-white/10 rounded-3xl p-8 lg:p-10 overflow-hidden"
//             style={{
//               opacity: animate ? 1 : 0,
//               clipPath: animate
//                 ? "inset(0% 0% 0% 0% round 24px)"
//                 : "inset(0% 0% 100% 0% round 24px)",
//               transition: `opacity 0.4s ease 0.25s, clip-path 0.8s cubic-bezier(0.22, 1, 0.36, 1) 0.25s`,
//             }}
//           >
//             {!submitted ? (
//               <>
...
//                         focus:outline-none focus:border-[#F5C400]/50 hover:border-white/20 transition-colors duration-200 appearance-none cursor-pointer"
