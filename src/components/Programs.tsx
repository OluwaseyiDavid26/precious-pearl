        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.6fr] gap-16 lg:gap-20 items-start">
          ...
          <div className="lg:sticky lg:top-32">
            ...
            >
              How we show
              <br />
              up for <span className="text-[#F5C400]">children.</span>
            </h2>
          ...
          <div className="space-y-3">
            {highlights.map((item, i) => (
              ...
              >
                {/* Hover fill */}
                <div className="absolute inset-0 bg-gradient-to-r from-[#F5C400]/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none" />
                ...
                {/* Text */}
                <div className="pt-[2px] flex-1 min-w-0 relative z-10">
                  <p className="text-white text-[15px] font-semibold leading-snug mb-1 group-hover:text-[#F5C400] transition-colors duration-300">
                    {item.label}
                  </p>
                  <p className="text-white/50 text-[13px] leading-[1.7]">
                    {item.detail}
