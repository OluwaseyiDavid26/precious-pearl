...
//               <Image
//                 src="/o61dh-removebg-preview.png"
//                 alt="Precious Pearl Support Initiative Logo"
//                 width={150} // Adjusted for a clean profile
//                 height={50}
          ...
          <div className="flex items-center justify-between h-[80px]">
            ...
            >
              ...
              <div className="flex flex-col leading-tight gap-[2px]">
                <span
                  className="text-white font-extrabold tracking-[0.05em] text-[16px]"
                  style={{ fontFamily: "Georgia, serif" }}
                >
                  PRECIOUS PEARL
                </span>
                <span
                  className="text-[#F5C400] font-semibold tracking-[0.12em] uppercase text-[9.5px]"
                  style={{ fontFamily: "'Barlow', sans-serif" }}
                >
                  Support Initiative
                </span>
