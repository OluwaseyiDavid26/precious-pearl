...
export default function GetInvolvedSection() {
  const { ref: sectionRef, visible: animate } = useScrollReveal(0.1);

  return (
    <section
      ref={sectionRef}
      className="relative bg-[#0a0f2c] py-28 px-6 overflow-hidden"
      style={{ fontFamily: "'DM Sans', sans-serif" }}
    >
      {/* Top rule */}
      ...
      <div className="max-w-5xl mx-auto relative">
        {/* ── Header: rotates up from below like a flap ── */}
        <div
          className="text-center mb-16"
          style={{
            opacity: animate ? 1 : 0,
            transform: animate
              ...
              : "perspective(600px) rotateX(12deg)",
            ...
            return (
              <div
                ...
                style={{
                  ...
                  transition: `opacity 0.75s cubic-bezier(0.22, 1, 0.36, 1) ${0.2 + i * 0.1}s,
                               transform 0.75s cubic-bezier(0.22, 1, 0.36, 1) ${0.2 + i * 0.1}s,
